...
var (
	...
	ErrOverflowUnpackingA             error = &Error{err: "overflow unpacking a"}
	ErrOverflowPackingA               error = &Error{err: "overflow packing a"}
	ErrOverflowUnpackingAAAA          error = &Error{err: "overflow unpacking aaaa"}
	ErrOverflowPackingAAAA            error = &Error{err: "overflow packing aaaa"}
	ErrOverflowHeaderSize             error = &Error{err: "overflowing header size"}
	ErrOverflowUnpackingUint8         error = &Error{err: "overflow unpacking uint8"}
	ErrOverflowPackingUint8           error = &Error{err: "overflow packing uint8"}
	ErrOverflowUnpackingUint16        error = &Error{err: "overflow unpacking uint16"}
	ErrOverflowPackingUint16          error = &Error{err: "overflow packing uint16"}
	ErrOverflowUnpackingUint32        error = &Error{err: "overflow unpacking uint32"}
	ErrOverflowPackingUint32          error = &Error{err: "overflow packing uint32"}
	ErrOverflowUnpackingUint64As48    error = &Error{err: "overflow unpacking uint64 as uint48"}
	ErrOverflowPackingUint64As48      error = &Error{err: "overflow packing uint64 as uint48"}
	ErrOverflowUnpackingUint64        error = &Error{err: "overflow unpacking uint64"}
	ErrOverflowPackingUint64          error = &Error{err: "overflow packing uint64"}
	ErrOverflowUnpackingTxt           error = &Error{err: "overflow unpacking txt"}
	ErrOverflowUnpackingBase32        error = &Error{err: "overflow unpacking base32"}
	ErrOverflowPackingBase32          error = &Error{err: "overflow packing base32"}
	ErrOverflowUnpackingBase64        error = &Error{err: "overflow unpacking base64"}
	ErrOverflowPackingBase64          error = &Error{err: "overflow packing base64"}
	ErrOverflowUnpackingHex           error = &Error{err: "overflow unpacking hex"}
	ErrOverflowPackingHex             error = &Error{err: "overflow packing hex"}
	ErrOverflowUnpackingAnything      error = &Error{err: "overflow unpacking anything"}
	ErrOverflowPackingAnything        error = &Error{err: "overflow packing anything"}
	ErrOverflowUnpackingOpt           error = &Error{err: "overflow unpacking opt"}
	ErrOverflowPackingOpt             error = &Error{err: "overflow packing opt"}
	ErrOverflowPackingNsec            error = &Error{err: "overflow packing nsec"}
	ErrOverflowUnpackingSVCB          error = &Error{err: "overflow unpacking SVCB"}
	ErrOverflowPackingSVCB            error = &Error{err: "overflow packing SVCB"}
	ErrOverflowUnpackingDomainNames   error = &Error{err: "overflow unpacking domain names"}
	ErrOverflowUnpackingAPLPrefix     error = &Error{err: "overflow unpacking APL prefix"}
	ErrOverflowPackingAPLPrefix       error = &Error{err: "overflow packing APL prefix"}
	ErrOverflowUnpackingAPLAddress    error = &Error{err: "overflow unpacking APL address"}
	ErrOverflowUnpackingNSEC3         error = &Error{err: "overflow unpacking NSEC(3)"}
	ErrOverflowNSEC3BlockInTypeBitmap error = &Error{err: "overflowing NSEC(3) block in type bitmap"}
)
